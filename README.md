...
| **Prasyarat**        | Sistem Basis Data, Komunikasi Data dan Jaringan Komputer |
...
| CPMK-2 | Mahasiswa mampu merancang dan mengelola infrastruktur Big Data untuk keperluan analisis menggunakan teknologi Big Data, seperti Apache Hadoop, Apache Spark, dan Spark MLlib. | CPL 2 (7.5%), CPL 3 (7.5%), CPL 6 (7.5%), CPL 7 (7.5%) | 30%   |
...
| **6**  | CPMK-2, CPMK-4        | Mahasiswa mampu menerapkan Spark MLlib untuk membangun pipeline machine learning terdistribusi  | - Ekosistem Spark MLlib `<br>`- Transformer, Estimator, Pipeline `<br>`- Feature Engineering: StringIndexer, VectorAssembler, StandardScaler `<br>`- Klasifikasi: Logistic Regression `<br>`- Regresi: Linear Regression | Ceramah, Praktikum                              | Membangun pipeline klasifikasi dan regresi menggunakan Spark MLlib untuk memprediksi data karyawan       | Keberhasilan pipeline ML; ketepatan evaluasi (AUC, Accuracy, RMSE, R²)                            | 7%            |
...
| Tugas Mingguan                    | Minggu 1–7, 9–14 | 20%            | CPMK-1, 2, 3, 4 |
